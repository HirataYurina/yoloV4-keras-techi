...
"""
    yolo.weights ---> yolo_weight.h5
"""


class Yolo4Tiny(object):
    ...
    def load_yolo(self):
        ...
        self.yolo4_model = yolo_body(Input(shape=(608, 608, 3)), num_anchors // 2, num_classes)
...
if __name__ == '__main__':
    ...
    model_path = '../logs/yolo4_tiny_weight.h5'
    anchors_path = '../model_data/tiny_yolo_anchors.txt'
    classes_path = '../model_data/coco_classes.txt'
    weights_path = '../logs/yolov4-tiny.weights'
    ...
    yolo4_model = Yolo4Tiny(score, iou, anchors_path, classes_path, model_path, weights_path)
